	...
	<?php if(!empty($char)): ?>
		...
		<div id="buy">		
			<div class="col-md-6">
			        	...
			        	<?php if(!empty($weapons[0])): ?>
			        		<?php $i=1; foreach($weapons as $w): ?>
			        			...
			        			<?php 
			        				...
			        				$tooltip .= "<div>";
			        			?>
			            		<li data-id="<?=$w['wid']?>" data-type="weapon" data-cost="<?=$w['cost'];?>" onmouseover="Tip('<?=$tooltip?>')" onmouseout="UnTip()">
				...
				<br />
				<div style="display: block" id="stuff_box">			
		    		<section id="product">
		        	<ul class="clear">
